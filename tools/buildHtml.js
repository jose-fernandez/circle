...
// The transformation is useful since we only want to track errors in the built production code.
...
fs.readFile('src/index.html', 'utf8', (readError, markup) => {
  ...
  if (useTrackJs) {
    if (trackJsToken) {
      ...
      console.log(chalkWarning('Sign up for a free trial at TrackJS.com and enter your token.'));
    }
  }
