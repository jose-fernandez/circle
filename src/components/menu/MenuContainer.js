...
import type { menuContainerType } from '../../reducers/types';
...
export class MenuContainer extends Component {
  ...
  render() {
    let clases: string = this.props.menu.MenuVisible ? 'menu-container-open' : 'menu-container';
    let glyphiconShow: string = this.props.menu.MenuVisible ? 'chevron-left' : 'chevron-right';
    return (
      <Panel
        header={'Menu'}
        bsStyle="info"
